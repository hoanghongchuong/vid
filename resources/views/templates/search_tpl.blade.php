            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="news-list">
                        ...
                        <div class="news-item">
                            <h4><a href="{{url('tin-tuc',$item->alias.'.html')}}" title="">{{$item->name}}</a> </h4>
                            <p class="date">{{date('d/m/Y', strtotime($item->created_at))}}</p>
                            <a href="{{url('tin-tuc',$item->alias.'.html')}}" title="" class="zoom"><img src="{{asset('upload/news/'.$item->photo)}}" alt="" title=""> </a>
